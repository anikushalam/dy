...
export const activateSportsAndArts = (builder) => {
  return builder.mutation({
    query: (data) => ({
      url: `/sport/arts/ins/${id}/staff/${data.sid}`,
      method: "POST",
    }),
  });
};
...
export const fetchSportsArts = (builder) => {
  return builder.query({
    query: (spid) => `/sport/arts/detail/${spid}`,
  });
};
...
export const createSportsClass = (builder) => {
  return builder.mutation({
    query: (data) => ({
      url: `/sport/arts/ins/${id}/sport/${data.sid}/class`,
      method: "POST",
      body: data.body,
    }),
  });
...
export const sportsArtsProfilePhotoFunction = (builder) => {
  return builder.mutation({
    query: (data) => ({
      url: `/all-images/${data.sid}/sport/photo`,
      method: "PATCH",
      body: data.profile,
    }),
  });
...
export const sportsArtsClassProfilePhotoFunction = (builder) => {
  return builder.mutation({
    query: (data) => ({
      url: `/all-images/${data.sid}/sport/class/photo`,
      method: "PATCH",
      body: data.profile,
    }),
  });
...
export const sportsArtsCoverPhotoFunction = (builder, method) => {
  return builder.mutation({
    query: (data) => ({
      url: `/all-images/${data.sid}/sport/cover`,
      method: `PATCH`,
      body: data.cover,
    }),
  });
...
export const sportsClassCoverPhoto = (builder) => {
  return builder.mutation({
    query: (data) => ({
      url: `/all-images/${data.sid}/sport/class/cover`,
      method: `PATCH`,
      body: data.cover,
    }),
  });
...
export const sportsEventDetails = (builder) => {
  return builder.query({
    query: (eid) => `/sport/arts/event/detail/${eid}`,
  });
};
...
export const sportsClassDetails = (builder) => {
  return builder.query({
    query: (cid) => `/sport/arts/class/detail/${cid}`,
  });
};
...
export const studentApprovedArray = (builder) => {
  return builder.query({
    query: (insId) => `/ins/${insId}/approve-student/list`,
  });
};
...
export const addStudentInSportClass = (builder) => {
  return builder.mutation({
    query: (data) => ({
      url: `/sport/arts/class/${data.cid}/student/add`,
      method: `POST`,
      body: data,
    }),
  });
...
export const rmoveStudentInSportClass = (builder) => {
  return builder.mutation({
    query: (data) => ({
      url: `/sport/arts/class/${data.cid}/student/remove`,
      method: `POST`,
      body: data,
    }),
  });
...
export const createNewMatchIntra = (builder) => {
  return builder.mutation({
    query: (data) => ({
      url: `/sport/arts/event/${data.eid}/match/intra`,
      method: "POST",
      body: data.matchData,
    }),
  });
...
export const createNewMatchInter = (builder) => {
  return builder.mutation({
    query: (data) => ({
      url: `/sport/arts/event/${data.eid}/match/inter`,
      method: "POST",
      body: data.matchData,
    }),
  });
...
export const AllMatchList = (builder) => {
  return builder.query({
    query: (data) =>
      `/sport/arts/event/${data.eid}/match?page=${data.page}&limit=10`,
  });
};
...
export const OngoingEventList = (builder) => {
  return builder.query({
    query: (data) =>
      `/sport/arts/detail/${data.id}/event?page=${data.page}&limit=10&status=Upcoming`,
  });
};
...
export const CompletedEventList = (builder) => {
  return builder.query({
    query: (data) =>
      `/sport/arts/detail/${data.id}/event?page=${data.page}&limit=10&status=Completed`,
  });
};
...
export const AllEventClassList = (builder) => {
  return builder.query({
    query: (data) =>
      `/sport/arts/detail/${data.sid}/all/class?page=${data.page}&limit=10`,
  });
};
...
export const MatchDetails = (builder) => {
  return builder.query({
    query: (mid) => `/sport/arts/match/detail/${mid}`,
  });
};
...
export const editIntraMatchResultIndividual = (builder) => {
  return builder.mutation({
    query: (data) => ({
      url: `/sport/arts/match/${data.mid}/update/intra/individual`,
      method: "POST",
...
export const editIntraMatchResultTeam = (builder) => {
  return builder.mutation({
    query: (data) => ({
      url: `/sport/arts/match/${data.mid}/update/intra/team`,
      method: "POST",
      body: data.resultData,
    }),
  });
...
export const editInterMatchResultTeam = (builder) => {
  return builder.mutation({
    query: (data) => ({
      url: `/sport/arts/match/${data.mid}/update/inter/team`,
      method: "POST",
      body: data.resultData,
    }),
  });
...
export const editInterMatchResultIndividual = (builder) => {
  return builder.mutation({
    query: (data) => ({
      url: `/sport/arts/match/${data.mid}/update/inter/individual`,
      method: "POST",
      body: data.resultData,
    }),
  });
...
export const editIntraMatchResultFreeStyle = (builder) => {
  return builder.mutation({
    query: (data) => ({
      url: `/sport/arts/match/${data.mid}/update/intra/free`,
      method: "POST",
      body: data.resultData,
    }),
  });
...
export const editInterMatchResultFreeStyle = (builder) => {
  return builder.mutation({
    query: (data) => ({
      url: `/sport/arts/match/${data.mid}/update/inter/free`,
      method: "POST",
      body: data.resultData,
    }),
  });
...
export const allClassStudentList = (builder) => {
  return builder.query({
    query: (cid) => `/sport/arts/class/${cid}/all/student`,
  });
};
...
export const allClassTeamList = (builder) => {
  return builder.query({
    query: (cid) => `/sport/arts/class/${cid}/all/team`,
  });
};
...
export const studentExtraSkillData = (builder) => {
  return builder.query({
    query: (sid) => `/sport/arts/student/event/query/${sid}/all`,
  });
};
...
export const studentMatchList = (builder) => {
  return builder.query({
    query: (data) =>
      `/sport/arts/student/event/query/${data.sid}/all/match/${data.eid}`,
  });
};
...
export const sportClassStudentList = (builder) => {
  return builder.query({
    query: (data) =>
      `/sport/arts/class/${data.cid}/all/student?page=${data.page}&limit=10`,
  });
};
...
export const sportClassTeamList = (builder) => {
  return builder.query({
    query: (data) =>
      `/sport/arts/class/${data.cid}/all/team?page=${data.page}&limit=10`,
  });
};
...
export const sportClassListStudent = (builder) => {
  return builder.query({
    query: (data) =>
      `/sport/arts/student/class/${data.sid}/query?page=${data.page}&limit=10`,
  });
};
...
export const sportClassTeamStudent = (builder) => {
  return builder.query({
    query: (data) =>
      `/sport/arts/student/team/${data.cid}/query?sid=${data.sid}`,
  });
};
...
export const sportsTeamDetailsStudent = (builder) => {
  return builder.query({
    query: (data) => `/sport/arts/team/${data.tid}/query`,
  });
};
